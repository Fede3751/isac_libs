...
class AgentRenderer(Node):
    def __init__(self):
        ...
        # Renderer will act as a controller in the simplified version, otherwise,
        # behavior and positions is given by the controller Gazebo instance
